...
#PRTG object ID for the device group you want to search in
PRTGgroup = ''
...
#Get a list of all probes in the specified PRTG group ID and return their name and object ID
#send request to prtg api, verify needed to ignore https cert warnings
r = requests.get('https://prtg.cc.lan/api/table.json?id=' + PRTGgroup + '&count=5000&content=probes&output=json&columns=objid,name&&username=' + myuser + '&password=' + mypassword, verify=False)
print "HTTPS Status Code: ", r.status_code
